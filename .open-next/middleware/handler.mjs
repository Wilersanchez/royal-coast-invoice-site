...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      var a7 = [".lcl.dev", ".lclstage.dev", ".lclclerk.com"], a8 = [".accounts.dev", ".accountsstage.dev", ".accounts.lclclerk.com"], a9 = [".lcl.dev", ".stg.dev", ".lclstage.dev", ".stgstage.dev", ".dev.lclclerk.com", ".stg.lclclerk.com", ".accounts.lclclerk.com", "accountsstage.dev", "accounts.dev"], ba = [".lcl.dev", "lclstage.dev", ".lclclerk.com", ".accounts.lclclerk.com"], bb = [".accountsstage.dev"], bc = "https://api.clerk.com", bd = { initialDelay: 125, maxDelayBetweenRetries: 0, factor: 2, shouldRetry: (a10, b10) => b10 < 5, retryImmediately: false, jitter: true }, be = async (a10) => new Promise((b10) => setTimeout(b10, a10)), bf = (a10, b10) => b10 ? a10 * (1 + Math.random()) : a10, bg = async (a10, b10 = {}) => {
        let c10 = 0, { shouldRetry: d10, initialDelay: e10, maxDelayBetweenRetries: f10, factor: g10, retryImmediately: h2, jitter: i2, onBeforeRetry: j2 } = { ...bd, ...b10 }, k2 = /* @__PURE__ */ ((a11) => {
          let b11 = 0;
          return async () => {
            await be((() => {
              let c11 = a11.initialDelay * Math.pow(a11.factor, b11);
              return c11 = bf(c11, a11.jitter), Math.min(a11.maxDelayBetweenRetries || c11, c11);
            })()), b11++;
          };
        ...
        for (; ; ) try {
          ...
          j2 && await j2(c10), h2 && 1 === c10 ? await be(bf(100, i2)) : await k2();
        }
      }, bh = (a10) => "undefined" != typeof atob && "function" == typeof atob ? atob(a10) : "undefined" != typeof global && global.Buffer ? new global.Buffer(a10, "base64").toString() : a10, bi = "pk_live_";
      function bj(a10) {
      ...
      function bk(a10, b10 = {}) {
        ...
        if (!(a10 = a10 || "") || !bl(a10)) {
          ...
          if (b10.fatal && !bl(a10)) throw Error("Publishable key not valid.");
          return null;
        }
        let d10 = a10.startsWith(bi) ? "production" : "development";
        try {
          c10 = bh(a10.split("_")[2]);
        } catch {
      ...
      function bl(a10 = "") {
        try {
          if (!(a10.startsWith(bi) || a10.startsWith("pk_test_"))) return false;
          let b10 = a10.split("_");
      ...
      async function bn(a10, b10 = globalThis.crypto.subtle) {
        var c10;
...
Clerk Trace ID: ${this.clerkTraceId}`), a11;
        ...
        try {
          let a11 = await function(a12, b11, c11) {
            ...
            let d11 = function(a13) {
              let b12 = bh(a13.replace(/-----BEGIN.*?-----/g, "").replace(/-----END.*?-----/g, "").replace(/\s/g, "")), c12 = new Uint8Array(new ArrayBuffer(b12.length));
      ...
      var cb = { SessionToken: "session_token", ApiKey: "api_key", M2MToken: "m2m_token", OAuthToken: "oauth_token" }, cc = class {
        ...
        initPublishableKeyValues(a10) {
          bk(a10.publishableKey, { fatal: true }), this.publishableKey = a10.publishableKey;
          let b10 = bk(this.publishableKey, { fatal: true, domain: a10.domain, isSatellite: a10.isSatellite });
          this.originalFrontendApi = b10.frontendApi;
          let c10 = bk(this.publishableKey, { fatal: true, proxyUrl: a10.proxyUrl, domain: a10.domain, isSatellite: a10.isSatellite });
      ...
      }, cd = async (a10, b10) => new cc(b10.publishableKey ? await bn(b10.publishableKey, bH.crypto.subtle) : "", a10, b10), ce = RegExp("(?<!:)/{1,}", "g");
      function cf(...a10) {
      ...
      var cH = class extends cg {
        ...
        async getUserOauthAccessToken(a10, b10) {
          ...
          return c10 && ((a11, b11, c11) => {
            let d11 = bo(), e10 = c11 ?? a11;
            bp.has(e10) || d11 || (bp.add(e10), console.warn(`Clerk - DEPRECATION WARNING: "${a11}" is deprecated and will be removed in the next major release.
${b11}`));
      ...
      async function eM(a10) {
        ...
        if (f10 || function() {
          ...
          let { keys: a11 } = await bg(() => eN(c10, b10, d10));
...
${a12.message}`);
      ...
      var e_ = async (a10, b10) => {
        ...
        if (d10 !== cb.M2MToken && (ca(c10.secretKey), c10.isSatellite)) {
          ...
          if (!e10 && bm(f10)) throw Error("Missing signInUrl. Pass a signInUrl for dev instances if an app is satellite");
      ...
      let fg = { Headers: { NextRewrite: "x-middleware-rewrite", NextResume: "x-middleware-next", NextRedirect: "Location", NextUrl: "next-url", NextAction: "next-action", NextjsData: "x-nextjs-data" } }, fh = (a10, b10, c10) => (a10.headers.set(b10, c10), a10);
      var fi = "__clerk_db_jwt";
      let fj = { rE: "15.5.6" }, fk = (a10) => {
      ...
      let fp = process.env.CLERK_API_VERSION || "v1", fq = process.env.CLERK_SECRET_KEY || "", fr = process.env.CLERK_MACHINE_SECRET_KEY || "", fs = "pk_test_d2FudGVkLWNyaWNrZXQtMzkuY2xlcmsuYWNjb3VudHMuZGV2JA", ft = process.env.CLERK_ENCRYPTION_KEY || "", fu = process.env.CLERK_API_URL || ((a10) => {
        let b10 = bk(a10)?.frontendApi;
      ...
      })(fs), fv = process.env.NEXT_PUBLIC_CLERK_DOMAIN || "", fw = process.env.NEXT_PUBLIC_CLERK_PROXY_URL || "", fx = fo(process.env.NEXT_PUBLIC_CLERK_IS_SATELLITE) || false, fy = process.env.NEXT_PUBLIC_CLERK_SIGN_IN_URL || "", fz = process.env.NEXT_PUBLIC_CLERK_SIGN_UP_URL || "", fA = fo(process.env.NEXT_PUBLIC_CLERK_TELEMETRY_DISABLED), fB = fo(process.env.NEXT_PUBLIC_CLERK_TELEMETRY_DEBUG), fC = fo(process.env.NEXT_PUBLIC_CLERK_KEYLESS_DISABLED) || false, fD = !(fj.rE.startsWith("13.") || fj.rE.startsWith("14.0")) && false, fE = (a10) => {
...
Original error: ${a10}`);
      ...
      var fG = class {
      ...
      }, fJ = /* @__PURE__ */ new Set(["error", "warn", "info", "debug", "trace"]), fK = { samplingRate: 1, maxBufferSize: 5, endpoint: "https://clerk-telemetry.com" }, fL = class {
        #g;
        #h;
        #i = {};
        #j = [];
        #k = null;
        constructor(a10) {
          this.#g = { maxBufferSize: a10.maxBufferSize ?? fK.maxBufferSize, samplingRate: a10.samplingRate ?? fK.samplingRate, perEventSampling: a10.perEventSampling ?? true, disabled: a10.disabled ?? false, debug: a10.debug ?? false, endpoint: fK.endpoint }, a10.clerkVersion || "undefined" != typeof window ? this.#i.clerkVersion = a10.clerkVersion ?? "" : this.#i.clerkVersion = "", this.#i.sdk = a10.sdk, this.#i.sdkVersion = a10.sdkVersion, this.#i.publishableKey = a10.publishableKey ?? "";
          let b10 = bk(a10.publishableKey);
          b10 && (this.#i.instanceType = b10.instanceType), a10.secretKey && (this.#i.secretKey = a10.secretKey.substring(0, 16));
          let c10 = fH.isSupported() ? new fH() : new fI();
          this.#h = new fG(c10);
        }
        get isEnabled() {
        ...
        recordLog(a10) {
          try {
            ...
            let b10 = "string" == typeof a10?.level && fJ.has(a10.level), c10 = "string" == typeof a10?.message && a10.message.trim().length > 0, d10 = null, e10 = a10?.timestamp;
      ...
      let fM = { secretKey: fq, publishableKey: fs, apiUrl: fu, apiVersion: fp, userAgent: "@clerk/nextjs@6.34.1", proxyUrl: fw, domain: fv, isSatellite: fx, machineSecretKey: fr, sdkMetadata: { name: "@clerk/nextjs", version: "6.34.1", environment: "production" }, telemetry: { disabled: fA, debug: fB } }, fN = (a10) => function(a11) {
        ...
        }({ options: b10, apiClient: c10 }), e10 = new fL({ publishableKey: b10.publishableKey, secretKey: b10.secretKey, samplingRate: 0.1, ...b10.sdkMetadata ? { sdk: b10.sdkMetadata.name, sdkVersion: b10.sdkMetadata.version } : {}, ...b10.telemetry || {} });
      ...
      var fP = c(521);
      let fQ = /* @__PURE__ */ new Map(), fR = new fP.AsyncLocalStorage();
      var fS = /* @__PURE__ */ new Set(), fT = { warnOnce: (a10) => {
        fS.has(a10) || (fS.add(a10), console.warn(a10));
      } };
      function fU(a10) {
...
For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)`, gQ = bw({ packageName: "@clerk/nextjs" }), gR = "x-middleware-override-headers", gS = "x-middleware-request", gT = (a10, b10, c10) => {
      ...
      function gW() {
        if (bo()) throw Error("Clerk: Unable to decrypt request data, this usually means the encryption key is invalid. Ensure the encryption key is properly set. For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)");
        throw Error(gP);
      }
      function gX(a10, b10) {
      ...
      let gY = async () => {
        ...
        let c10;
        try {
          let a11 = await fF(), b11 = fO(a11, b6.Headers.ClerkRequestData);
          c10 = function(a12) {
            if (!a12) return {};
            let b12 = bo() ? ft || fq : ft || fq || gV;
            try {
              return gX(a12, b12);
            } catch {
              if (fD) try {
          ...
          if (a11 && fE(a11)) throw a11;
        }
        let d10 = null != (b10 = null == (a10 = fR.getStore()) ? void 0 : a10.get("requestData")) ? b10 : c10;
        return (null == d10 ? void 0 : d10.secretKey) || (null == d10 ? void 0 : d10.publishableKey) ? fN(d10) : fN({});
      };
      class gZ {
        ...
        return fR.run(fQ, () => {
          let a11 = /* @__PURE__ */ ((a12, b11) => (...c11) => {
            let d11 = ("string" == typeof a12 ? /* @__PURE__ */ ((a13, b12) => () => {
              ...
              return { enable: () => {
                ...
                if (d12) {
                  ...
                  console.log((f11 = a13, `[clerk debug end: ${f11}] (@clerk/nextjs=6.34.1,next=${fj.rE},timestamp=${Math.round((/* @__PURE__ */ new Date()).getTime() / 1e3)})`));
                }
              } };
            ...
            let h2, i2, j2, k2, l2, m2, n2, o2, p2 = "function" == typeof e10 ? await e10(b11) : e10, q2 = await g1((a13) => {
              ...
              return a13 || b12(), a13;
            }(p2.publishableKey || fs || (null == q2 ? void 0 : q2.publishableKey), () => gQ.throwMissingPublishableKeyError()), s2 = function(a13, b12) {
              return a13 || b12(), a13;
            }(p2.secretKey || fq || (null == q2 ? void 0 : q2.secretKey), () => gQ.throwMissingSecretKeyError()), t2 = { publishableKey: r2, secretKey: s2, signInUrl: p2.signInUrl || fy, signUpUrl: p2.signUpUrl || fz, ...p2 };
            fQ.set("requestData", t2);
            let u2 = await gY();
            t2.debug && a12.enable();
            let v2 = eF(b11);
            ...
            let y2 = await u2.authenticateRequest(v2, ((a13, b12) => ({ ...b12, ...((a14, b13) => {
              ...
              c12 = d11 && !fU(d11) ? new URL(d11, a14.clerkUrl).toString() : d11;
              ...
              if (e11 && !fU(g12) && bm(b13.secretKey || fq)) throw Error(gO);
            ...
            let F2 = R.next();
            try {
              F2 = await fR.run(fQ, async () => null == d10 ? void 0 : d10(E2, b11, c11)) || F2;
            } catch (a13) {
              F2 = ((a14, b12, c12, d11) => {
                var e11;
                ...
                if (f12 || g12) {
                  let c13 = ((a15) => {
                    let { publishableKey: b13, redirectAdapter: c14, signInUrl: d12, signUpUrl: e12, baseUrl: f13, sessionStatus: g14 } = a15, h3 = bk(b13), i3 = h3?.frontendApi, j3 = h3?.instanceType === "development", k3 = bV(i3), l3 = "pending" === g14, m3 = (b14, { returnBackUrl: d13 }) => c14(b7(f13, `${b14}/tasks`, d13, j3 ? a15.devBrowserToken : null));
            ...
            if (t2.contentSecurityPolicy) {
              ...
              }((null != (g11 = null == (f11 = bk(r2)) ? void 0 : f11.frontendApi) ? g11 : "").replace("$", ""), t2.contentSecurityPolicy);
              b12.forEach(([a13, b13]) => {
                fh(F2, a13, b13);
            ...
            if (y2.headers && y2.headers.forEach((b12, c12) => {
              ...
              if ("true" === b12.headers.get(b6.Headers.ClerkRedirectTo) && d11 && bm(c12.secretKey) && a13.clerkUrl.isCrossOrigin(d11)) {
            ...
            return !function(a13, b12, c12, d11, e11, f12) {
              ...
              if (g12) {
                let c13 = function(a14, b13, c14) {
                  ...
                  if (a14.secretKey && !ft) return void fT.warnOnce("Clerk: Missing `CLERK_ENCRYPTION_KEY`. Required for propagating `secretKey` middleware option. See docs: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys");
                  let f13 = bo() ? ft || (d12 = () => gQ.throwMissingSecretKeyError(), fq || d12(), fq) : ft || fq || gV;
                  return gJ.encrypt(JSON.stringify({ ...b13, ...a14, machineAuthObject: null != c14 ? c14 : void 0 }), f13).toString();
                }(d11, e11, f12);
                gT(b12, a13, { [b6.Headers.AuthStatus]: j3, [b6.Headers.AuthToken]: k3 || "", [b6.Headers.AuthSignature]: k3 ? gM(k3, (null == d11 ? void 0 : d11.secretKey) || fq || e11.secretKey || "").toString() : "", [b6.Headers.AuthMessage]: i3 || "", [b6.Headers.AuthReason]: h3 || "", [b6.Headers.ClerkUrl]: a13.clerkUrl.toString(), ...c13 ? { [b6.Headers.ClerkRequestData]: c13 } : {} }), b12.headers.set(fg.Headers.NextRewrite, g12.href);
              }
            ...
            }), i2 = !(g11.publishableKey || fs || (null == h2 ? void 0 : h2.publishableKey)), j2 = null != (f11 = null == (d11 = fO(b11, b6.Headers.Authorization)) ? void 0 : d11.replace("Bearer ", "")) ? f11 : "";
            if (i2 && !ep(j2)) {
              let a12 = R.next();
              return gT(a12, b11, { [b6.Headers.AuthStatus]: "signed-out" }), a12;
            }
            return a11(b11, c11);
          }, g10 = async (b11, c11) => fD ? f10(b11, c11) : a11(b11, c11);
          return b10 && c10 ? g10(b10, c10) : g10;
        });
      })((a10, b10) => {
        hf(b10) || a10.protect();
      }), hh = { matcher: ["/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)", "/(api|trpc)(.*)"] };
      c(747);
